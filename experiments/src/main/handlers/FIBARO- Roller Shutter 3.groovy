...
metadata {
    definition(name: "Fibaro Roller Shutter 3", namespace: "FibarGroup", author: "Paulo Verdelho", ocfDeviceType: "oic.d.blind", mnmn: "SmartThings", vid: "generic-shade-2") {
...
private handleLevelReport(physicalgraph.zwave.Command cmd) {
    ...
    def switchEvent = createEvent(name: "switch", value: switchValue, isStateChange: levelEvent.isStateChange)

    logging("${device.displayName} - Setting level to ${level}, windowsShade to ${shadeValue} and switch to ${switchValue}", "info")
